  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <div class="belonging">This is a RSS Feed generated by <a href="https://github.com/Spotren/spotren-sites/tree/main/ndEX-builder"
            target="_blank">ndEX Builder</a>. RSS readers can use the URL in the address bar.</div>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>
